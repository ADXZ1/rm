...
ROBOT_ARM_ROOT = os.path.abspath(os.path.join(CURRENT_DIR, ".."))
PROJECT_ROOT = os.path.abspath(os.path.join(ROBOT_ARM_ROOT, ".."))

for path in (ROBOT_ARM_ROOT, PROJECT_ROOT):
...
file_path = get_sequential_filepath("/home/maic/rm1/RM_API2-main/RM_API2-main/Demo/vertical_grab/code/robot_arm/Path")
