...
class RobotController:
    ...
    def __init__(self):
        # 设置Python脚本所在的路径
        self.dst_path = "/home/maic/rm1/RM_API2-main/RM_API2-main/Demo/vertical_grab/code/robot_arm"
        os.chdir(self.dst_path)
        
        # 添加 vertical_grab 模块的父目录到 Python 路径
        vertical_grab_parent = "/home/maic/rm1/RM_API2-main/RM_API2-main/Demo/vertical_grab"
        ...
        self.translation_vector = [-0.07797346114669192, 0.0607491485688067, -0.09132410501940941]

        # 加载模型
        self.yolo_model = YOLO("/home/maic/rm1/runs/train/bottle/weights/best.pt")
        self.sam_model = SAM("sam2.1_l.pt")

        # 手眼标定参数
        self.rotation_matrix = [[0.013632, 0.99971, 0.019696], 
    ...
    def spawn_robot2(self, robot2):
        ...
        try:
            ...
            print(f"robot2目标位置: {target_pose2}")
